import template from './new-message-fly.pug';

class NewMessageFlycontroller {
  /* @ngInject */
...
const NewMessageFlyComponent = {
  template,
  controller: NewMessageFlycontroller,
};

export default NewMessageFlyComponent;
