import template from './list-message-fly.pug';
class ListMessageFlyController {
  /* @ngInject */
  ...
  get() {
    this
      .$http
      .get(`/messageFlies`, { params: this.params})
      .then(({ data }) => {
...
const ListMessageFlyComponent = {
  template,
  controller: ListMessageFlyController,
};

export default ListMessageFlyComponent;
