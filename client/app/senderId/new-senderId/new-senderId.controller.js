import template from './new-senderId.pug';

class NewSenderIdcontroller {
  /* @ngInject */
...
const NewSenderIdComponent = {
  template,
  controller: NewSenderIdcontroller,
};

export default NewSenderIdComponent;
