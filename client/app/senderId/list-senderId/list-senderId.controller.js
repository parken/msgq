import template from './list-senderId.pug';
class ListSenderIdController {
  /* @ngInject */
  ...
  get() {
    this
      .$http
      .get(`/senderIds`, { params: this.params})
      .then(({ data }) => {
...
const ListSenderIdComponent = {
  template,
  controller: ListSenderIdController,
};

export default ListSenderIdComponent;
