import template from './list-priorityNumber.pug';
class ListPriorityNumberController {
  /* @ngInject */
  ...
  get() {
    this
      .$http
      .get(`/priorityNumbers`, { params: this.params})
      .then(({ data }) => {
...
const ListPriorityNumberComponent = {
  template,
  controller: ListPriorityNumberController,
};

export default ListPriorityNumberComponent;
