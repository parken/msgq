import template from './new-sending.pug';

class NewSendingcontroller {
  /* @ngInject */
...
const NewSendingComponent = {
  template,
  controller: NewSendingcontroller,
};

export default NewSendingComponent;
