import template from './new-loginIdentifier.pug';

class NewLoginIdentifiercontroller {
  /* @ngInject */
...
const NewLoginIdentifierComponent = {
  template,
  controller: NewLoginIdentifiercontroller,
};

export default NewLoginIdentifierComponent;
