import template from './list-loginIdentifier.pug';
class ListLoginIdentifierController {
  /* @ngInject */
  ...
  get() {
    this
      .$http
      .get(`/loginIdentifiers`, { params: this.params})
      .then(({ data }) => {
...
const ListLoginIdentifierComponent = {
  template,
  controller: ListLoginIdentifierController,
};

export default ListLoginIdentifierComponent;
